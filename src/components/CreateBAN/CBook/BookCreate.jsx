...
const BookCreate = () => {
  ...
  const [books, setBooks] = useState("หนังสือการ์ตูน");
  ...
  const handleSummit = async (e) => {
    ...
    formData.append("typebookAndnovel", books);
      ...
      {load ? (
        ...
        <div className="box-bg-book-cte">
          <div className="box-container-book filter-drop-container">
            <div className="title-h-book">สร้างหนังสือการ์ตูนของฉัน</div>
          </div>
          <div className="box-container-book filter-drop-container">
                ...
                <div className="co">
                  <div className="flex-row">
                    <input
                      ...
                      value="เล่มเดี่ยว"
                      name="ctypebook"
                      onChange={(e) => setCtypeBook(e.target.value)}
                    />
                    <label
